...
import { getAllBusinesses as getAllBusinessesServer, getAllCategories as getAllCategoriesServer, getCategoryData as getCategoryDataServer, AVAILABLE_BUSINESSES } from "@/data/businessData";
      ...
      if (sub) {
        ...
        if (cityName) {
          ...
          if (isValidBusiness) {
            ...
            const category = getCategoryDataServer(sub.toLowerCase());
            if (category) {
...
// Função para obter todos os subdomínios disponíveis (com dados completos para cliente)
export function getAllBusinesses(): Array<{ subdomain: string; city: string; data: BusinessData }> {
  ...
  AVAILABLE_BUSINESSES.forEach(({ subdomain, city }) => {
...
// Função para obter todas as categorias disponíveis (wrapper para compatibilidade)
export function getAllCategories(): string[] {
  return getAllCategoriesServer();
}

// Função para obter dados de categoria (wrapper para compatibilidade)
export function getCategoryData(categoryName: string): CategoryData | null {
  return getCategoryDataServer(categoryName);
}
